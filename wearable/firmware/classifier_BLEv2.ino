...
void setup() {
  ...
  tflOpsResolver.AddQuantize();     // ← CRITICAL: converts float32 input → int8
  tflOpsResolver.AddDequantize();   // ← CRITICAL: converts int8 output → float32
